...
create_generated_clock -source [get_ports CLOCK_50] -name clk_31p5 [get_pins {inst7|clk_31p5_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]

create_generated_clock -source [get_pins {inst7|...|divclk}] -name out_aud_xck [get_ports AUD_XCK]
#**************************************************************
# Set Clock Latency
#**************************************************************
