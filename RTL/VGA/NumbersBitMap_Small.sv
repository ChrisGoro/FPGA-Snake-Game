...
//assign address = ((digit_location_MIF*digit)+((offsetY)*OBJECT_WIDTH_X + (offsetX))); 		 //Original size of digit
assign address = ((digit_location_MIF*digit)+((offsetY<<1)*OBJECT_WIDTH_X + (offsetX<<1)));	 //Half size
